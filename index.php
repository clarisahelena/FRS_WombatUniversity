...
<head>
    ...
    <style>
        *{box-sizing:border-box;margin:0;padding:0;font-family:'Calibri',Calibri,sans-serif}
        ...
        .tabs label{flex:1;text-align:center;padding:10px;border-radius:8px;font-size:15px;font-weight:600;color:#64748b;cursor:default;transition:all .15s}
        .tabs .active-tab{background:#fff;color:#2563eb;box-shadow:0 1px 3px rgba(0,0,0,.08)}
...
<div class="card">
    ...
    <form method="POST">
        ...
        <div class="tabs">
            <label class="active-tab">Mahasiswa</label>
        </div>
